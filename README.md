## Ассистент приложения на Laravel 8.x

Ассистент приложения на Laravel 8.x является графической оболочкой для часто используемых команд консоли командной строки и включает в себя несколько пошаговых мастеров:
...
### Подключение
 ...
 - **2** Для подключения в уже созданный проект воспользуйтесь командной строкой:
    ...
    ```console
    composer require russsiq/laravel-assistant:^0.1
    ```
